import {
  ...
  stepBefore,
  step_default
} from "./chunk-AIF3J2CA.js";
import {
  select_default
} from "./chunk-7ZPAL6XY.js";
import {
  cubehelix,
  cubehelixLong,
  rgb,
  rgbBasis
} from "./chunk-TRMXRSMW.js";
import {
  __commonJS,
  __toESM
    ...
    !function(t, e) {
      ...
      var _ = function() {
        ...
        return m2.parse = function(t2) {
          ...
          var r2 = t2 || "YYYY-MM-DDTHH:mm:ssZ", i2 = b.z(this), s2 = this.$H, u5 = this.$m, a2 = this.$M, o2 = n2.weekdays, c5 = n2.months, f2 = n2.meridiem, h2 = function(t3, n3, i3, s3) {
            ...
            return r3 || function(t4) {
              switch (t4) {
                ...
                case "MM":
                  return b.s(a2 + 1, 2, "0");
                case "MMM":
                  return h2(n2.monthsShort, a2, c5, 3);
                case "MMMM":
                  return h2(c5, a2);
                case "D":
                  return e2.$D;
...
function axis(orient, scale2) {
  var tickArguments = [], tickValues = null, tickFormat = null, tickSizeInner = 6, tickSizeOuter = 6, tickPadding = 3, offset = typeof window !== "undefined" && window.devicePixelRatio > 1 ? 0 : 0.5, k = orient === top || orient === left ? -1 : 1, x2 = orient === left || orient === right ? "x" : "y", transform = orient === top || orient === bottom ? translateX : translateY;
  function axis2(context) {
    var values = tickValues == null ? scale2.ticks ? scale2.ticks.apply(scale2, tickArguments) : scale2.domain() : tickValues, format2 = tickFormat == null ? scale2.tickFormat ? scale2.tickFormat.apply(scale2, tickArguments) : identity_default : tickFormat, spacing = Math.max(tickSizeInner, 0) + tickPadding, range2 = scale2.range(), range0 = +range2[0] + offset, range1 = +range2[range2.length - 1] + offset, position2 = (scale2.bandwidth ? center : number)(scale2.copy(), offset), selection = context.selection ? context.selection() : context, path2 = selection.selectAll(".domain").data([null]), tick = selection.selectAll(".tick").data(values, scale2).order(), tickExit = tick.exit(), tickEnter = tick.enter().append("g").attr("class", "tick"), line2 = tick.select("line"), text2 = tick.select("text");
...
function parser(type3) {
  return (input, init2) => text_default(input, init2).then((text2) => new DOMParser().parseFromString(text2, type3));
}
...
function find_default(x2, y2, radius) {
  var data, x02 = this._x0, y0 = this._y0, x12, y1, x22, y22, x3 = this._x1, y3 = this._y1, quads = [], node2 = this._root, q, i;
  if (node2) quads.push(new quad_default(node2, x02, y0, x3, y3));
  ...
  while (q = quads.pop()) {
    if (!(node2 = q.node) || (x12 = q.x0) > x3 || (y1 = q.y0) > y3 || (x22 = q.x1) < x02 || (y22 = q.y1) < y0) continue;
    if (node2.length) {
...
function remove_default(d) {
  ...
  var parent, node2 = this._root, retainer, previous, next2, x02 = this._x0, y0 = this._y0, x12 = this._x1, y1 = this._y1, x2, y2, xm, ym, right2, bottom2, i, j;
...
function polygonContains_default(polygon, point) {
  ...
  for (var i = 0, n = polygon.length; i < n; ++i) {
    ...
    for (var j = 0; j < m; ++j, lambda0 = lambda1, sinPhi0 = sinPhi1, cosPhi0 = cosPhi1, point0 = point1) {
      var point1 = ring[j], lambda1 = longitude(point1), phi1 = point1[1] / 2 + quarterPi, sinPhi1 = sin2(phi1), cosPhi1 = cos2(phi1), delta = lambda1 - lambda0, sign2 = delta >= 0 ? 1 : -1, absDelta = sign2 * delta, antimeridian = absDelta > pi2, k = sinPhi0 * sinPhi1;
...
function compareIntersection(a, b) {
  return ((a = a.x)[0] < 0 ? a[1] - halfPi2 - epsilon4 : halfPi2 - a[1]) - ((b = b.x)[0] < 0 ? b[1] - halfPi2 - epsilon4 : halfPi2 - b[1]);
}
...
function clipAntimeridianInterpolate(from2, to, direction, stream) {
  ...
  if (from2 == null) {
    ...
    stream.point(-pi2, 0);
    stream.point(-pi2, phi2);
  } else if (abs3(from2[0] - to[0]) > epsilon4) {
...
function eachBefore_default(callback, that) {
  var node2 = this, nodes = [node2], children, i, index = -1;
  while (node2 = nodes.pop()) {
    callback.call(that, node2, ++index, this);
...
function eachAfter_default(callback, that) {
  var node2 = this, nodes = [node2], next2 = [], children, i, n, index = -1;
  while (node2 = nodes.pop()) {
    next2.push(node2);
    if (children = node2.children) {
...
function slice_default(parent, x02, y0, x12, y1) {
  var nodes = parent.children, node2, i = -1, n = nodes.length, k = parent.value && (y1 - y0) / parent.value;
  while (++i < n) {
    node2 = nodes[i], node2.x0 = x02, node2.x1 = x12;
    node2.y0 = y0, node2.y1 = y0 += node2.value * k;
  }
}
...
var svg2 = freeze(["accent-height", "accumulate", "additive", "alignment-baseline", "amplitude", "ascent", "attributename", "attributetype", "azimuth", "basefrequency", "baseline-shift", "begin", "bias", "by", "class", "clip", "clippathunits", "clip-path", "clip-rule", "color", "color-interpolation", "color-interpolation-filters", "color-profile", "color-rendering", "cx", "cy", "d", "dx", "dy", "diffuseconstant", "direction", "display", "divisor", "dur", "edgemode", "elevation", "end", "exponent", "fill", "fill-opacity", "fill-rule", "filter", "filterunits", "flood-color", "flood-opacity", "font-family", "font-size", "font-size-adjust", "font-stretch", "font-style", "font-variant", "font-weight", "fx", "fy", "g1", "g2", "glyph-name", "glyphref", "gradientunits", "gradienttransform", "height", "href", "id", "image-rendering", "in", "in2", "intercept", "k", "k1", "k2", "k3", "k4", "kerning", "keypoints", "keysplines", "keytimes", "lang", "lengthadjust", "letter-spacing", "kernelmatrix", "kernelunitlength", "lighting-color", "local", "marker-end", "marker-mid", "marker-start", "markerheight", "markerunits", "markerwidth", "maskcontentunits", "maskunits", "max", "mask", "mask-type", "media", "method", "mode", "min", "name", "numoctaves", "offset", "operator", "opacity", "order", "orient", "orientation", "origin", "overflow", "paint-order", "path", "pathlength", "patterncontentunits", "patterntransform", "patternunits", "points", "preservealpha", "preserveaspectratio", "primitiveunits", "r", "rx", "ry", "radius", "refx", "refy", "repeatcount", "repeatdur", "restart", "result", "rotate", "scale", "seed", "shape-rendering", "slope", "specularconstant", "specularexponent", "spreadmethod", "startoffset", "stddeviation", "stitchtiles", "stop-color", "stop-opacity", "stroke-dasharray", "stroke-dashoffset", "stroke-linecap", "stroke-linejoin", "stroke-miterlimit", "stroke-opacity", "stroke", "stroke-width", "style", "surfacescale", "systemlanguage", "tabindex", "tablevalues", "targetx", "targety", "transform", "transform-origin", "text-anchor", "text-decoration", "text-rendering", "textlength", "type", "u1", "u2", "unicode", "values", "viewbox", "visibility", "version", "vert-adv-y", "vert-origin-x", "vert-origin-y", "width", "word-spacing", "wrap", "writing-mode", "xchannelselector", "ychannelselector", "x", "x1", "x2", "xmlns", "y", "y1", "y2", "z", "zoomandpan"]);
...
var Channel = {
  ...
  rgb2hsl: ({ r, g, b }, channel2) => {
    ...
    if (max4 === min2)
      return 0;
    const d = max4 - min2;
    const s = l > 0.5 ? d / (2 - max4 - min2) : d / (max4 + min2);
    if (channel2 === "s")
      return s * 100;
    switch (max4) {
      case r:
...
var Lang = {
  /* API */
  clamp: (number3, lower, upper) => {
    if (lower > upper)
      return Math.min(lower, Math.max(upper, number3));
    return Math.min(upper, Math.max(lower, number3));
  },
  round: (number3) => {
...
var HSL = {
  ...
  _hue2deg: (hue) => {
    ...
    if (match2) {
      const [, number3, unit] = match2;
      switch (unit) {
        case "grad":
          return utils_default.channel.clamp.h(parseFloat(number3) * 0.9);
        case "rad":
          return utils_default.channel.clamp.h(parseFloat(number3) * 180 / Math.PI);
        case "turn":
          return utils_default.channel.clamp.h(parseFloat(number3) * 360);
      }
    }
...
var identity_default4 = identity;
...
function baseRest(func, start) {
  return setToString_default(overRest_default(func, start, identity_default4), func + "");
}
...
function delimit(type3) {
  return trim(slice3(position - 1, delimiter(type3 === 91 ? type3 + 2 : type3 === 40 ? type3 + 1 : type3)));
}
...
function escaping(index, count2) {
  while (--count2 && next())
    if (character < 48 || character > 102 || character > 57 && character < 65 || character > 70 && character < 97)
      break;
  return slice3(index, caret() + (count2 < 6 && peek() == 32 && next() == 32));
}
...
function commenter(type3, index) {
  while (next())
    if (type3 + character === 47 + 10)
      ...
      break;
  return "/*" + slice3(index, position - 1) + "*" + from(type3 === 47 ? type3 : next());
}
    ...
    switch (previous = character2, character2 = next()) {
      case 40:
        if (previous != 108 && charat(characters2, length2 - 1) == 58) {
          if (indexof(characters2 += replace(delimit(character2), "&", "&\f"), "&\f", abs4(index ? points[index - 1] : 0)) != -1)
            ampersand = -1;
          break;
        }
      case 34:
      ...
      case 0:
        switch (character2) {
          ...
          case 59:
            characters2 += ";";
          default:
            append(reference = ruleset(characters2, root2, parent, index, offset, rules, points, type3, props = [], children = [], length2, rulesets), rulesets);
            if (character2 === 123)
              if (offset === 0)
                ...
                if (offset) parse(value, reference, reference, rule && append(ruleset(value, reference, reference, 0, 0, rules, points, type3, rules, props = [], length2, children), children), rules, children, length2, points, rule ? props : children);
...
function ruleset(value, root2, parent, index, offset, rules, points, type3, props, children, length2, siblings) {
  var post = offset - 1;
  var rule = offset === 0 ? rules : [""];
  var size = sizeof(rule);
  for (var i = 0, j = 0, k = 0; i < index; ++i)
    for (var x2 = 0, y2 = substr(value, post + 1, post = abs4(j = points[i])), z = value; x2 < size; ++x2)
...
// node_modules/mermaid/dist/mermaid-7ea9cbd6.js
...
var renderKatexUnsanitized = async (text2, config2) => {
  if (!hasKatex(text2)) {
    return text2;
  }
  ...
  const { default: katex } = await import("./katex-EX22CUGL.js");
...
var renderKatexSanitized = async (text2, config2) => {
...
var loader$m = async () => {
  const { diagram: diagram2 } = await import("./c4Diagram-c83219d4-P4AHCNLZ.js");
...
var loader$l = async () => {
  const { diagram: diagram2 } = await import("./flowDiagram-50d868cf-3TRKESXH.js");
...
var loader$k = async () => {
  const { diagram: diagram2 } = await import("./flowDiagram-v2-4f6560a1-MOJC7UHV.js");
...
var loader$j = async () => {
  const { diagram: diagram2 } = await import("./erDiagram-0228fc6a-HBDMSWLO.js");
...
var loader$i = async () => {
  const { diagram: diagram2 } = await import("./gitGraphDiagram-82fe8481-VH2AVA2Q.js");
...
var loader$h = async () => {
  const { diagram: diagram2 } = await import("./ganttDiagram-a2739b55-GCAXDLXU.js");
...
var loader$g = async () => {
  const { diagram: diagram2 } = await import("./infoDiagram-8eee0895-NIATJPCS.js");
...
var loader$f = async () => {
  const { diagram: diagram2 } = await import("./pieDiagram-a8764435-7RMQTKDJ.js");
...
var loader$e = async () => {
  const { diagram: diagram2 } = await import("./quadrantDiagram-1e28029f-CPDLCMMT.js");
...
var loader$d = async () => {
  const { diagram: diagram2 } = await import("./xychartDiagram-f5964ef8-UKNE7VAF.js");
...
var loader$c = async () => {
  const { diagram: diagram2 } = await import("./requirementDiagram-08caed73-BU6ZWPUZ.js");
...
var loader$b = async () => {
  const { diagram: diagram2 } = await import("./sequenceDiagram-c5b8d532-KGF2UHFR.js");
...
var loader$a = async () => {
  const { diagram: diagram2 } = await import("./classDiagram-beda092f-TVGV4MMT.js");
...
var loader$9 = async () => {
  const { diagram: diagram2 } = await import("./classDiagram-v2-2358418a-MJPCB7TL.js");
...
var loader$8 = async () => {
  const { diagram: diagram2 } = await import("./stateDiagram-1ecb1508-BHORJDDO.js");
...
var loader$7 = async () => {
  const { diagram: diagram2 } = await import("./stateDiagram-v2-c2b004d7-Q46U23MM.js");
...
var loader$6 = async () => {
  const { diagram: diagram2 } = await import("./journeyDiagram-c64418c1-FYW6TRFP.js");
...
var loader$5 = async () => {
  const { diagram: diagram2 } = await import("./flowchart-elk-definition-6af322e1-3N7FXAW2.js");
...
var loader$4 = async () => {
  const { diagram: diagram2 } = await import("./timeline-definition-faaaa080-HO7CVGEV.js");
...
var loader$3 = async () => {
  const { diagram: diagram2 } = await import("./mindmap-definition-8da855dc-N2JDTBQ2.js");
...
var loader$2 = async () => {
  const { diagram: diagram2 } = await import("./sankeyDiagram-a04cb91d-PNHQHKOO.js");
...
var loader$1 = async () => {
  const { diagram: diagram2 } = await import("./blockDiagram-c4efeb88-N4WDGAKG.js");
...
function resolveYamlBinary(data) {
  if (data === null)
    return false;
  var code, idx, bitlen = 0, max4 = data.length, map2 = BASE64_MAP;
...
function constructYamlBinary(data) {
  var idx, tailbits, input = data.replace(/[\r\n=]/g, ""), max4 = input.length, map2 = BASE64_MAP, bits = 0, result = [];
  for (idx = 0; idx < max4; idx++) {
    if (idx % 4 === 0 && idx) {
...
function representYamlBinary(object) {
  var result = "", bits = 0, idx, tail, max4 = object.length, map2 = BASE64_MAP;
  for (idx = 0; idx < max4; idx++) {
    if (idx % 3 === 0 && idx) {
...
var runThrowsErrors = async function({ postRenderCallback, querySelector, nodes } = {
  ...
  for (const element of Array.from(nodesToProcess)) {
    ...
    try {
      const { svg: svg3, bindFunctions } = await render(id2, txt, element);
...
export {
  ...
  apply_default,
  overRest_default,
  constant_default7 as constant_default,
  shortOut_default,
  setToString_default,
  baseRest_default,
...
mermaid/dist/mermaid-7ea9cbd6.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-YRUODL5F.js.map
